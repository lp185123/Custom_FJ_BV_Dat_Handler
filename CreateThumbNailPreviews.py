...
def main():
    ...
    #default path
    FilePath=r"E:\NCR\Currencies\Zambia\Sorted\20A_ZMW"
    #FilePath=r"C:\Working\Currencies\01_MM8_DC\SR_TURKEY_MM8_DC\KA00001256\MM8"
    #FilePath = str(input("Paste in input folder from Windows Explorer and press enter - nested folders supported "))
    ...
    while(1):
            ...
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.UP:#"UP":
            ...
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.DOWN:#"DOWN":
                if UserManualMemoryScan.Multiplier==0:
                    UserManualMemoryScan.Offset=int(UserManualMemoryScan.Offset-(UserManualMemoryScan.Width))
                else:
                    UserManualMemoryScan.Offset=int(UserManualMemoryScan.Offset-(UserManualMemoryScan.Width *(UserManualMemoryScan.Multiplier*UserManualMemoryScan.Multiplier)))

            if UserRequest==BV_DatReader_Lib.UserOperationStrings.LEFT2:#"LEFT2":
                UserManualMemoryScan.Offset=int(UserManualMemoryScan.Offset+(1 *UserManualMemoryScan.Multiplier))
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.RIGHT2:#"RIGHT2":
                UserManualMemoryScan.Offset=int(UserManualMemoryScan.Offset-(1 *UserManualMemoryScan.Multiplier))

            if UserRequest==BV_DatReader_Lib.UserOperationStrings.LEFT:#"LEFT":
                UserManualMemoryScan.Width=int(UserManualMemoryScan.Width-(1*UserManualMemoryScan.Multiplier))
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.RIGHT:#"RIGHT":
                UserManualMemoryScan.Width=int(UserManualMemoryScan.Width+(1*UserManualMemoryScan.Multiplier))

            if UserRequest==BV_DatReader_Lib.UserOperationStrings.UP2:#"UP2":
                UserManualMemoryScan.Height=int(UserManualMemoryScan.Height-(1*(UserManualMemoryScan.Multiplier^2)))
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.DOWN2:#"DOWN2":
                UserManualMemoryScan.Height=int(UserManualMemoryScan.Height+(1*(UserManualMemoryScan.Multiplier^2)))

            if UserRequest==BV_DatReader_Lib.UserOperationStrings.RANDOM:#"RANDOM":
            ...
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.A:#"A":
            ...
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.B:#"B":
            ...
            if UserRequest==BV_DatReader_Lib.UserOperationStrings.COLOURS:#"COLOURS":
