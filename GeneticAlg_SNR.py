...
class GA_Parameters():
    def __init__(self):
        ...
        self.TestImageBatchSize=50#how many images do we test per iteration. For best results use entire dataset, this is tested to work up
        ...
        self.ImageColumnSize=1#how many images we send at a time to external OCR, don't go more than 40 as performance breaks down

        self.NewImageCycle=10#how many iterations/generations of same image set before choosing another random subset of main images. If you set this too low frequency for image switching it could overtrain to the subset
        ...
        self.ForceFieldingLengths=[10]#put in list of expected SN lengths - use this if the s39/images do not yet have SNR answers from the template
