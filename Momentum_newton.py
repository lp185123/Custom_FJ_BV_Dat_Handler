...
# Direction being a unit length vector giving the heading of your ship. Power
#  being the amount of thrust you want to add (Zero when no acceleration is needed)
#   ElapsedTime is the time between your game Update calls to keep movement smooth 
#   even when your framerate is changing
